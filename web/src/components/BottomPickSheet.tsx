...
export function BottomPickSheet({
  ...
  // This component always schedules through window.setTimeout. Using the DOM
  // handle type avoids Node's global Timeout type leaking in through the
  // workspace's shared TypeScript configuration.
