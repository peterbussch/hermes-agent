...
def _build_result_entry(
    ...
    # Fork keeps the guardrail-halt verdict (turn_exit_reason/guardrail ride through to the entry below);
    # upstream v0.21.4 adds partial-answer recovery for an interrupted child. Different conditions, so both stay.
    interrupt_note = ""
