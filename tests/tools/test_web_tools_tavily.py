...
class TestWebExtractTavily:
    ...
    def test_extract_dispatches_to_tavily(self):
        ...
        with patch("tools.web_tools._get_extract_backend", return_value="tavily"), \
             ...
             patch("plugins.web.jina.provider.JinaReaderWebSearchProvider.extract", new=unexpected_fallback), \
             patch("plugins.web.local_browser.provider.LocalBrowserWebSearchProvider.extract", new=unexpected_fallback):
